...
from main import chunk_documents_for_store, load_documents_from_files
from src import (
...
def run() -> dict:
    ...
    docs_for_store = chunk_documents_for_store(docs, chunk_size=1200)
...
if __name__ == "__main__":
    report_data = run()
    output_path = Path("report/report_data.json")
